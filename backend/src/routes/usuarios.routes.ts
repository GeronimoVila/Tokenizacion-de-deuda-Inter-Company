...
import { preRegistrarUsuario, obtenerUsuarios, cambiarEstadoUsuario, modificarUsuario} from '../controllers/usuarios.controller.js';
...
router.patch('/:id', requerirRol([ROLES.ADMIN_HOLDING]), modificarUsuario);
